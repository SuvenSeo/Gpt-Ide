...
void test("parses quoted command arguments without invoking a shell", () => {
...
void test("maps common file extensions to editor languages", () => {
...
void test("normalizes direct and bridge-wrapped tool results", () => {
